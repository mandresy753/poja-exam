package course.register.demo.handler;

import static course.register.demo.concurrency.ThreadRenamer.renameWorkerThread;
...
import course.register.demo.PojaApplication;
import course.register.demo.PojaGenerated;
import course.register.demo.endpoint.EndpointConf;
import course.register.demo.endpoint.event.EventConf;
import course.register.demo.endpoint.event.consumer.EventConsumer;
import course.register.demo.endpoint.event.consumer.model.ConsumableEvent;
import course.register.demo.endpoint.event.consumer.model.ConsumableEventTyper;
