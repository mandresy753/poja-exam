package image.submisson.demo.handler;

import static image.submisson.demo.concurrency.ThreadRenamer.renameWorkerThread;
...
import image.submisson.demo.PojaApplication;
import image.submisson.demo.PojaGenerated;
import image.submisson.demo.endpoint.EndpointConf;
import image.submisson.demo.endpoint.event.EventConf;
import image.submisson.demo.endpoint.event.consumer.EventConsumer;
import image.submisson.demo.endpoint.event.consumer.model.ConsumableEvent;
import image.submisson.demo.endpoint.event.consumer.model.ConsumableEventTyper;
