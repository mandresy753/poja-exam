package image.submisson.demo.endpoint.event.consumer;

import image.submisson.demo.PojaGenerated;
import image.submisson.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("course.register.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "course.register.demo.service.event."
